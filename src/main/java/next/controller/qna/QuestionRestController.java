...
@Controller
public class QuestionRestController extends AbstractNewController {
	private Logger log = LoggerFactory.getLogger(QuestionRestController.class); 
	...
	@Inject 
	public QuestionRestController(QnaService qnaService, QuestionDao questionDao, AnswerDao answerDao) { 
